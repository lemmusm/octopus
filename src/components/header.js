...
const Header = () => {
  ...
  return (
    <header className="lg:px-32 px-6 flex flex-wrap items-center lg:py-10 py-2 justify-center">
      <Link className="flex items-center flex-shrink-0 mr-6" to="/">
        ...
        <LogoText className="font-bold ml-3 text-xl">OCTOPUS</LogoText>
        <Path>{path}</Path>
      </Link>
      <div className="flex-1 items-center w-auto w-full">
        <nav className="flex items-center justify-between flex-wrap p-6">
          <div className="w-full items-center w-auto ">
            <ul className="text-sm flex justify-between sm:float-right md:float-right lg:float-right xl:float-right">
              <li className="mr-6">
                <Link
                  to={"/"}
